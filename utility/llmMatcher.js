...
Say: [Utterance](Correct Answer: [Answer])(Visual Aid: [Description])(Common Misconceptions: [Incorrect Answers])
...
**Correct Answer:** Ensure that the provided correct answer is accurate based on the information provided in the utterance and the visual aid. This should be checked step by step:
    ...
    1.5. Consider the Common Misconceptions tag as examples of incorrect answers to help identify potential errors.
    1.6. If the calculated correct answer matches the one provided in the instruction, mark it as accurate. Otherwise, mark it as inaccurate.
